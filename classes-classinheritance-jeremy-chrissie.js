...
class Car {
    constructor(model, year, wheels, speed) {
        this.model = model
        this.year = year
        this.wheels = wheels
        this.lights = "off"
    ...
    carInfo (){
        return `${this.model} was built in ${this.year} it has ${this.wheels} wheels.`
    }
}
// Challenges
...
let myCar = new Car ("generic car", 1999, 4)
myCar.carInfo()
...
//     }
// }
// var myTesla = new Tesla ("6", 2012, 4)
// myTesla.speedUp()
// myTesla.signalOn()
// myTesla.lightsOn()
// myTesla.carInfo()
...
//     }
// }
// var myToyota = new Toyota ("Camry", 1995, 4)
// myToyota.speedUp()
// myToyota.lightsOn()
// myToyota.signalOn()
// myToyota.carInfo()
...
//     }
// }
// var myVolkswagen = new Volkswagen ("Jetta", 2017, 4)
