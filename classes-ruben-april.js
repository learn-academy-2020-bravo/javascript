...
volume(){
  var answer = Math.PI*this.radius**2*this.height
  // var rounded = answer.toFixed(4)
return answer.toFixed(4)
}
}

var mustang = new Cylinder("2", "1")
// mustang = mustang.toFixed(4)

console.log(mustang.volume())
